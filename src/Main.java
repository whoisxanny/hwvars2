public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Даня теперь получает " + dennisSalaryNew + " рублей. Годовой доход вырос на " + (dennisSalaryNew - dennisSalary) + " рублей");
        System.out.println("Кристик теперь получает " + kristinaSalaryNew + " рублей. Годовой доход вырос на " + (kristinaSalaryNew - kristinaSalary) + " рублей");
    }
}